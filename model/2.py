...
import math
from blender import Blender  # 假设我们有一个Blender实现
...
class MotionTransformer(nn.Module):
    ...
    def blend_samples(self, samples):
        """
        Blend the generated samples using the Blender.
        :param samples: a batch of generated samples.
        :return: blended samples.
        """
        return self.blender.blend(samples)
